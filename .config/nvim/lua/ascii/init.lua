...
-- Carga del arte general
local art = require("ascii.art")

-- Carga del arte de neovim (M.sharp)
local neovim_art_ok, neovim_art = pcall(require, "ascii.text.neovim")
if neovim_art_ok and neovim_art.sharp then
    art.sharp = neovim_art.sharp
end
